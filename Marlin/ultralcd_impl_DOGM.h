...
#elif ENABLED(MKS_OLED242_128x64_FULL_GRAPHICS_CONTROLLER)
...
static void lcd_implementation_init() {
  ...
  #if !defined(LCD_RESET_PIN) && (ENABLED(MKS_12864OLED) || ENABLED(MKS_12864OLED_SSD1306) || ENABLED(MKS_OLED242_128x64_FULL_GRAPHICS_CONTROLLER))
